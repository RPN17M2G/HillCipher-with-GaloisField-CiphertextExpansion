 ...
 * @param dimentation - The dimension of the encryption matrix.
 ...
 *
 * @param[out] out_plaintext - Pointer to the output plaintext array - allocated inside the function and memory released if fails.
 * @param[out] out_plaintext_size - Pointer to the size of the plaintext in bits.
 * @param[in] decryption_matrix - The decryption matrix used for the Hill Cipher.
 * @param[in] dimentation - The dimension of the decryption matrix.
 * @param[in] prime_field - The prime field to use for modular arithmetic.
 * @param[in] ciphertext_vector - The ciphertext vector to be decrypted.
 * @param[in] vector_size - The size of the ciphertext vector in bits.
 * @return STATUS_CODE - Status of the operation.
 */
