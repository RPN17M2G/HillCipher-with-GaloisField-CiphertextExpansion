 ...
 * @param error_vector_matrix - Matrix of error vectors for affine transformation (size: number_of_error_vectors x dimension).
 * @param number_of_error_vectors - Number of error vectors (rows in error_vector_matrix).
 * @return STATUS_CODE - Status of the operation.
 */
STATUS_CODE encrypt(int64_t** out_ciphertext, uint32_t* out_ciphertext_size, int64_t** encryption_matrix, uint32_t dimension, uint32_t prime_field, uint8_t* plaintext_vector, uint32_t vector_size, uint32_t number_of_random_bits, int64_t** error_vector_matrix, uint32_t number_of_error_vectors);
 ...
 * @return STATUS_CODE - Status of the operation.
 */
STATUS_CODE decrypt(uint8_t** out_plaintext, uint32_t* out_plaintext_size, int64_t** decryption_matrix, uint32_t dimension, uint32_t prime_field, int64_t* ciphertext_vector, uint32_t vector_size, uint32_t number_of_random_bits, int64_t** error_vector_matrix, uint32_t number_of_error_vectors);
