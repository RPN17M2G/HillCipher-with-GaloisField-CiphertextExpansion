...
enum STATUS_CODE
{
	...
	STATUS_CODE_COULDNT_OPEN_FILE,
	STATUS_CODE_ERROR_INVALID_FILE_SIZE,
	STATUS_CODE_COULDNT_READ_FILE,
	STATUS_CODE_FILE_NOT_BINARY,
	STATUS_CODE_INPUT_FILE_DOESNT_EXISTS_OR_NOT_WRITEBLE,
	STATUS_CODE_OUTPUT_FILE_NOT_BINARY,
	STATUS_CODE_OUTPUT_FILE_NOT_TEXT,
	STATUS_CODE_ERROR_INVALID_SIZE,
	STATUS_CODE_CONVERSION_FAILED,
